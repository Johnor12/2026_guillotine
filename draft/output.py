...
from shared.league import POSITIONS, REGULAR_WEEKS, STARTING_SLOTS, TEAMS, WEEKLY_SHAPES, WEEKS
...
def build_payload(
    ...
    return {
        ...
        "method": (
            ...
            "the converged guillotine week weights; see draft/rank.py and draft/*.py."
        ),
        "league": {
            "teams": TEAMS,
            "format": (
        ...
        "my_next_picks": {
            "note": (
                ...
                "him. See draft/rankings.py and draft/planning.py."
            ),
