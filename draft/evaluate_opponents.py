...
Usage:
    uv run -m draft.evaluate_opponents
"""
...
from shared.paths import BOARDS, DRAFT, POOL

from .board import load_board
from .opponents import build_opponent_strategies
from .pool import Player, load_pool
from .settings import NOISE
from .simulation import Draft
from .sources import investigate as source_investigator
from .value import seed_levels
...
def preference_order(model: Draft, slot: int) -> list[Player]:
    candidates = model.opponent_candidates(0, slot)
