...
Usage:
    ...
    uv run -m draft.sources.investigate --report
"""
...
from shared.names import SUFFIXES, normalized_name, words
from shared.paths import BOARDS, DRAFT
from shared.paths import SOURCE_MATCHES as REPORT
