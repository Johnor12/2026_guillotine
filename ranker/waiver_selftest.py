...
from .claims import _record_values, claims
from .league import WEEKS
from .race import RaceInputs, _auction, claim_plan, replay
from .season import lineup_points
from .waivers import Bidding, Manager, fit_managers, submitted_bids
...
class WaiverTests(unittest.TestCase):
    ...
    def test_capacity_and_same_drop_claims(self):
        for roster in (self.roster[:], self.roster[:-1]):
            ...
            _auction(inputs, 1, rosters, budgets, [True], free, random.Random(7), None, [1.0], 40)
